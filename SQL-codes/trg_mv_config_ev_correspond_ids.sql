DROP FUNCTION IF EXISTS config_data.trg_mv_config_ev_correspond_ids() CASCADE;
CREATE FUNCTION config_data.trg_mv_config_ev_correspond_ids()
...
DROP TRIGGER IF EXISTS trg_it_mv_config_ev_correspond_ids ON config_data.mv_configuration_events; 
 CREATE TRIGGER trg_it_mv_config_ev_correspond_ids
	...
	EXECUTE PROCEDURE config_data.trg_mv_config_ev_correspond_ids();	

DROP TRIGGER IF EXISTS trg_dt_mv_config_ev_correspond_ids ON config_data.mv_configuration_events; 
...
DROP TRIGGER IF EXISTS trg_ut_mv_config_ev_correspond_ids ON config_data.mv_configuration_events; 
