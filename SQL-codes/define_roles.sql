...
GRANT select, insert, update, delete ON ALL TABLES IN SCHEMA config_data TO polconfdb_1;
GRANT execute ON ALL FUNCTIONS IN SCHEMA config_data TO polconfdb_1;

GRANT select, insert, update, delete ON ALL TABLES IN SCHEMA beta_version TO polconfdb_1;
GRANT execute ON ALL FUNCTIONS IN SCHEMA beta_version TO polconfdb_1;

GRANT select, insert, update, delete ON ALL TABLES IN SCHEMA updates TO polconfdb_1;
GRANT execute ON ALL FUNCTIONS IN SCHEMA updates TO polconfdb_1;

GRANT ALL PRIVILEGES ON SCHEMA config_data TO polconfdb_1;
GRANT ALL PRIVILEGES ON SCHEMA beta_version TO polconfdb_1;
GRANT ALL PRIVILEGES ON SCHEMA updates TO polconfdb_1;
